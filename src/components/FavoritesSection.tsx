...
function FavoriteModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center bg-black/55 px-4 py-6 backdrop-blur-md"
      onClick={onClose}
    >
      <div
      ...
      >
        <div className="grid max-h-[88vh] md:grid-cols-[1.05fr_0.95fr]">
          <div className="relative min-h-[280px] md:min-h-[640px]">
            <img
              src={item.image}
              alt={item.title}
              className="absolute inset-0 h-full w-full object-cover"
                      ...
                      return (
                        ...
                        >
                          <FavoriteCard
                            ...
                            onClick={
                              canExpand ? () => setSelected({ item, category: group.category }) : undefined
                            }
                          />
                        </ScrollStackItem>
                      );
